...
init([Port, NumAcceptors]) ->
  ...
  BackendEventManager = {backend_event, {backend_event, start_link, []}, permanent, 2000, worker, [backend_event]},
  ...
  Children = [AcceptorSupervisor, ProxySupervisor, BackendEventManager, BackendServer, EquServer],
